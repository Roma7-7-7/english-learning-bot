...
# See when service last restarted
systemctl show english-learning-bot.service | grep ActiveEnterTimestamp

# Count errors in logs (last hour)
sudo journalctl -u english-learning-bot.service --since "1 hour ago" | grep -i error | wc -l
